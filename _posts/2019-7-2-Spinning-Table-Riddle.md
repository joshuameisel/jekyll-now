...
n is not a power of 2 if and only if it’s divisible by some odd m > 1. Then there are evenly spaced coins *i*<sub>1</sub>, *i*<sub>2</sub>,..., *i*<sub>*m*</sub>. There is no solution because if you start in a configuration where *i*<sub>1</sub>,..., *i*<sub>*m*</sub> is not homogeneous (not all heads or all tails), there is no guarantee you will ever escape this state.
